...
<div id="container-menu">
	...
	<div id="contentWrapper">
                        ...
                        <div id="contentFeaturePod" class="PodLeft">
								<cf_pods location="featureHomepageLeft" type="description">
                        </div>
                        
                        <div id="contentFeaturePod" class="PodMid">
                            	<cf_pods location="featureHomepageMid" type="description">
                        </div>
                        
                        <div id="contentFeaturePod" class="PodRight">
                        		<cf_pods location="featureHomepageRight" type="description">
                        </div>
